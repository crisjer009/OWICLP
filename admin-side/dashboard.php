...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* =========================================================
   MAIN CONTENT - EXISTING STYLE (For reference)
========================================================= */
.main {
    flex: 1;
    padding: 30px; /* Reduced padding slightly for better content fit */
    background: #1e1924;
    margin-left: 280px;
    min-height: 100vh;
}
...
.card {
    background: #25202b; /* Slightly lighter than background */
    padding: 25px;
    border-radius: 15px;
    display: flex;
    justify-content: space-between;
...
.main-dashboard-grid {
    display: grid;
    grid-template-columns: 2fr 1fr; /* 66% Table, 33% Chart */
    gap: 20px;
}
