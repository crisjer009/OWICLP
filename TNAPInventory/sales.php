  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" id="content_title">ADD SALES</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <form method="post" name="cof_form" id="cof_form" enctype="multipart/form-data">
        ...
        <div class="col-md-3 input-group mb-3">
                ...
                <div class="col-md-3 input-group mb-3">
                  ...
                  <input type="date" class="form-control" name="consign_tag" id="tag_id" value="<?php echo date('m-d-Y')?>" >
            ...
            <button type="button" class="btn-success" id="btn_save" class="btn btn-info">UPDATE</button>
...
function coftagres(tag_id){
    ...
    console.log(tag_id);
//data table start
$.post('functions/fetch_data.php',{tag_id:tag_id, mode:'sales_datatbl'},function(data){
console.log(data);
cof1_datatable(data);
},'json');
}
...
{title:"TIME / DATE", data:"date_created","defaultContent": "",},
...
footerCallback: function (row, data, start, end, display) {
            ...
            // Update footer
            $(api.column(5).footer()).html('TOTAL QTY:' );
            $(api.column(6).footer()).html(pageTotal1 );
...
$('#sls_id').val(data['cof_id']);
$('#genMod_branch_id').val(genmodfetch);

    } );

    $(document).on("submit", "#gen_sales_form", function (e) {
    e.preventDefault();
    e.stopImmediatePropagation();
