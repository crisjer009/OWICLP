...
<div class="col-md-6 mb-4">
  <input type="text" class="form-control" name="cof" id="cof" placeholder="Input COF Series #" value="<?php echo $_POST['cofdel']; ?>" readonly>
<input type="hidden" name="branch_id" id="branch_id">
<input type="hidden" name="ld_user_secID" id="ld_user_secID">
<input type="hidden" name="ld_series" id="ld_series">
...
<div class="col-md-2"><input type="submit" id="snp" name="snp" value="Create DR" class="form-control btn-success"></div>
  ...
  $( "#extract" ).on( "click", function(e) {
    ...
    success:function(data)
    {
      ...
      if (a[0].dr_tag != 'Y') {
        ...
        alert('THIS COF HAVE ALREADY DR RECEIPT')
        $('#extract').prop('disabled', true);
        $('#snp').prop('disabled', true);
