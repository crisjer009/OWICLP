<div class="modal fade" id="gen_dr_modal">
  ...
  <form method="post" name="gen_dr_form" id="gen_sales_form" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="row text-center">      
         ...
         <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" name="sls_id" id="sls_id" readonly >
                </div>   
          ...
          <div class="input-group mb-3">
               ...
               <!-- operation -->
               <input type="hidden" name="operation" id="operation" value="Sales_Edit" >
