<div class="modal fade" id="upt_modal">
    ...
    <div class="modal-content">
      ...
      <div class="row text-center border border-secondary ">                 
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" name="owi_desc" id="owi_desc">
                </div>   
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text">PG UPC:</span>
                  </div>
                  <input type="text" class="form-control" name="pg_upc" id="pg_upc">
                </div> 
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" name="sku_price" id="sku_price" required>
                </div>    
                
               <!-- user id -->
               <input type="hidden"  name="user_id" id="user_id" value="<?php echo $_SESSION['user_id'];?>" >
               
               <input type="hidden"  name="prev_price" id="prev_price" >
               <input type="hidden"  name="prev_upc_" id="prev_upc_" >
               <input type="hidden" name="upt_reason" id="upt_reason">
               <!-- date updated -->
