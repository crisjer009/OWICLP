...
<head>
    <meta charset="utf-8">
    <title>Admin Dashboard | Loyalty Program</title>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="admin_pcustomer.php"><i class="fas fa-user-shield"></i>Customer</a></li>
        <li><a href="admin_loyalty.php"><i class="fas fa-gift"></i> Loyalty Points</a></li>
        <li><a href="admin_rewards.php"><i class="fas fa-exchange-alt"></i> Rewards</a></li>
        <li><a href="admin_tier.php"><i class="fas fa-exchange-alt"></i> Tier and Membership</a></li>
        <hr class="text-white opacity-25">
        <li><a href="admin_settings.php"><i class="fas fa-file-invoice"></i> Settings</a></li>
